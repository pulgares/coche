...
def Calefacion():
    ...
    button15 = tk.Button(otra_ventana, image=imagenatras,fg="White",command=lift_win1)
...
def Luces():
    ...
    button18 = tk.Button(otra_ventana1, image=imagenatras,fg="White",command=lift_win1)
    button18.place (x=410, y=300)
...
def Puertas():
    ...
    button21 = tk.Button(otra_ventana2, image=imagenatras,fg="White", command=lift_win1)
    button21.place (x=410, y=300)
...
def Sensores():
    ...
    button21 = tk.Button(otra_ventana3, image=imagenatras, fg="White", command=lift_win1)
    button21.place (x=410, y=300)
    button21.config( height = 96, width = 96 )
    button21.config(bg="black")
    root.iconify()
